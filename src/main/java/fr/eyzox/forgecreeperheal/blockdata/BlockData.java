...
import fr.eyzox.forgecreeperheal.healer.*;
...
public class BlockData implements fr.eyzox.dependencygraph.interfaces.IData<BlockPos>, ISerialWrapperProvider<BlockData>, IChunked, IHealable, IRemovable, INBTSerializable<NBTTagCompound> {
    ...
    // "Mojang appears to be using @Deprecated as a mark of vanilla MC methods that should be used by internals and subclasses of Block" (Mojang bad practices ... deal with it)
